...
class DifferentUploadFilePage extends StatefulWidget {
  @override
  _DifferentUploadFilePageState createState() =>
      _DifferentUploadFilePageState();
}

class _DifferentUploadFilePageState extends State<DifferentUploadFilePage> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            //           crossAxisSpacing: 10,
            //           //mainAxisSpacing: 10,
            //           children: [Image.asset('assets/images/pdf2.jpg')])
            //       : Container()
            // GridView.builder(
            //     shrinkWrap: true,
            //     physics: NeverScrollableScrollPhysics(),
            //     itemCount: _file1.length,
            ...
            //     ),
            //     children: [Image.asset('assets/images/file1.png')]),
            //Text(_file1.join())
